...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    int32_t                         mi4Rotation;
#ifdef ACCESS_BEAUTIFIER
    int32_t                         mi4Flip;			//add jpg flip
    int32_t                         mi4SmartSkin;			//add access
    int32_t                         mi4WhiteNing;			//add access
    int32_t                         mi4EnableAccess;			//add access
#endif
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Interfaces.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////                    Instantiation.
                                    ShotParam(
                                        ...
                                        #ifdef ACCESS_BEAUTIFIER
                                                                                                    ,
                                        int32_t const           i4Flip              = 0,
                                        int32_t const           i4SmartSkin              = 100,
                                        int32_t const           i4WhiteNing              = 100,
                                        int32_t const           i4EnableAccess              = 0
                                        #endif
                                    )
                                        ...
                                        #ifdef ACCESS_BEAUTIFIER
                                        , mi4Flip(i4Flip)
                                        , mi4SmartSkin(i4SmartSkin)
                                        , mi4WhiteNing(i4WhiteNing)
                                        , mi4EnableAccess(i4EnableAccess)
                                        #endif
                                        //
                                    {
                                    }
    ...
    ShotParam&                      operator=(ShotParam const& rhs)
                                    {
                                        ...
                                        #ifdef ACCESS_BEAUTIFIER
                                        mi4Flip         = rhs.mi4Flip;
					                                mi4SmartSkin         = rhs.mi4SmartSkin;
					                                mi4WhiteNing         = rhs.mi4WhiteNing;
					                                mi4EnableAccess         = rhs.mi4EnableAccess;
					                                #endif
                                        return  (*this);
                                    }
};
