...
#else			
static UINT32 DoCamCalModuleVersion_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize,UINT32* pGetSensorCalData);
static UINT32 DoCamCalPartNumber_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
//static UINT32 DoCamCalShadingTable(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
static UINT32 DoCamCalSingleLsc_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
static UINT32 DoCamCalN3dLsc_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
static UINT32 DoCamCalAWBGain_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
static UINT32 DoCamCal2AGain_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
static UINT32 DoCamCal3AGain_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
static UINT32 DoCamCal3DGeo_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData);
...
static const CALIBRATION_LAYOUT_STRUCT CalLayoutTbl[MAX_CALIBRATION_LAYOUT_NUM]=
{
	{//CALIBRATION_LAYOUT_SLIM_LSC1 without Defect //data sheet of excel : "Slim"
		...
		{
			{0x00000001, 0x00000000, 0x00000000, DoCamCalModuleVersion_darling}, //CAMERA_CAM_CAL_DATA_MODULE_VERSION
			{0x00000001, 0x00000000, 0x00000000, DoCamCalPartNumber_darling}, //CAMERA_CAM_CAL_DATA_PART_NUMBER
			{0x00000001, 0x0000000C, 0x00000284, DoCamCalSingleLsc_darling}, //CAMERA_CAM_CAL_DATA_SHADING_TABLE
			{0x00000001, 0x00000004, 0x00000008, DoCamCalAWBGain_darling}, //CAMERA_CAM_CAL_DATA_3A_GAIN
			{0x00000000, 0x00000000, 0x00000000, DoCamCal3DGeo_darling}  //CAMERA_CAM_CAL_DATA_3D_GEO
		}
	},
	{//CALIBRATION_LAYOUT_N3D //data sheet of excel : "3D_EEPROM 8M+2M _0A_2"
		0x00000000, 0x020A00FF,CAM_CAL_N3D_DATA,
		{
			{0x00000001, 0x00000002, 0x00000000, DoCamCalModuleVersion_darling}, //CAMERA_CAM_CAL_DATA_MODULE_VERSION
			{0x00000001, 0x00000000, 0x00000018, DoCamCalPartNumber_darling}, //CAMERA_CAM_CAL_DATA_PART_NUMBER
			{0x00000001, 0x1480009C, 0x00000840, DoCamCalN3dLsc_darling}, //CAMERA_CAM_CAL_DATA_SHADING_TABLE
			{0x00000001, 0x1400001C, 0x00000080, DoCamCal3AGain_darling}, //CAMERA_CAM_CAL_DATA_3A_GAIN
			{0x00000001, 0x00000A00, 0x00000898, DoCamCal3DGeo_darling}  //CAMERA_CAM_CAL_DATA_3D_GEO
		}
	},	
	...
	{//CALIBRATION_LAYOUT_SENSOR_OTP
		...
		{		
			{0x00000001, 0x00000000, 0x00000000, DoCamCalModuleVersion_darling}, //CAMERA_CAM_CAL_DATA_MODULE_VERSION
			{0x00000001, 0x00000005, 0x00000002, DoCamCalPartNumber_darling}, //CAMERA_CAM_CAL_DATA_PART_NUMBER
			{0x00000001, 0x00000017, 0x00000001, DoCamCalSingleLsc_darling}, //CAMERA_CAM_CAL_DATA_SHADING_TABLE
			{0x00000001, 0x00000007, 0x0000000E, DoCamCal2AGain_darling}, //CAMERA_CAM_CAL_DATA_3A_GAIN
			{0x00000000, 0x00000000, 0x00000000, DoCamCal3DGeo_darling}  //CAMERA_CAM_CAL_DATA_3D_GEO
		}
	}	
};
...
*******************************************************************************/
static UINT32 DoCamCalLayoutCheck_darling(void)
{
...
*
*******************************************************************************/
UINT32 OV5648MIPIRAW_CAM_CALGetCalData_darling(UINT32* pGetSensorCalData)
{	
    UCHAR cBuf[128] = "/dev/";	
    UCHAR HeadID[5] = "NONE";	
    UINT32 result = CAM_CAL_ERR_NO_DEVICE;
...
//    CAM_CAL_LOG_IF(dumpEnable,"CAM_CALGetCalData(0x%8x)----\n",(unsigned int)pGetSensorCalData);
    ...
    if(DoCamCalLayoutCheck_darling()==CAM_CAL_ERR_NO_ERR)
    {  
...
*******************************************************************************/
static UINT32 DoCamCalDataReset_darling(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData)
{
