...
//                   THH2  TH2  THL2                   THH1  TH1  THL1
	...
	if (sensorID == OV5648MIPI_SENSOR_ID ||sensorID == OV5648MIPI_SENSOR_ID_DARLING_ZL )//LINE <> <DATE20130917> <OV5648 tuning> wupingzhou
	{
		THL1 = 3300;
		THH1 = 3500;//3484;
	}
	else if (sensorID == OV5649MIPI_SENSOR_ID || sensorID == OV5648MIPI_SENSOR_ID_SUNWIN)//LINE <> <DATE20130917> <OV5648 tuning> wupingzhou
	{
//		THL1 = 4000;
//		THH1 = 4200;//3484;
		THL1 = 3900;
	...
	else if(sensorID == OV8825_SENSOR_ID)
	{
		LOGD("[-evaluate_Shading_CCT_index][OV8825MIPI] This is sunny MTM module.");

		THL1	= 2850;
		THH1	= 3484;
		THL2	= 4500;
		THH2	= 4700;
		TH3			= 20;//50;	//20130103 Jouny
	}
	else if(sensorID == OV8826_SENSOR_ID)
	{
		LOGD("[-evaluate_Shading_CCT_index][OV8825MIPI] This is sunny MTM module.");
    ...
    case eIDX_Shading_CCT_CWF:
        ...
        else
        {
			...
			else if (sensorID == OV5648MIPI_SENSOR_ID ||sensorID == OV5648MIPI_SENSOR_ID_DARLING_ZL)//LINE <> <DATE20131104> <camera shading tuning> wupingzhou
			{
				if(i4DFIDX < -20)
				{
					eIdx_Shading_CCT_new = eIDX_Shading_CCT_CWF;
			...
			else if (sensorID == OV5649MIPI_SENSOR_ID || sensorID == OV5648MIPI_SENSOR_ID_SUNWIN)//LINE <> <DATE20131104> <camera shading tuning> wupingzhou
			{
				if(i4DFIDX < -50)
				{
					eIdx_Shading_CCT_new = eIDX_Shading_CCT_CWF;
			...
			else if (sensorID == OV8825_SENSOR_ID || sensorID == OV8826_SENSOR_ID)//LINE <> <DATE20131104> <camera shading tuning> wupingzhou
			{
				if(i4DFIDX < TH3)
				{
					eIdx_Shading_CCT_new = eIDX_Shading_CCT_CWF;
