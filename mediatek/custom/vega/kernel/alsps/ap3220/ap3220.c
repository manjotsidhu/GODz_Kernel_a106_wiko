...
int ap3220_setup_eint(struct i2c_client *client)
{
	...
	//LINE <alsps> <DATE20130701> <ap3220> zhangxiaofei removed
	...
	mt_eint_registration(CUST_EINT_ALS_NUM, CUST_EINT_ALS_TYPE, ap3220_eint_func, 0);
...
{
	APS_FUN();
	i2c_register_board_info(2, &i2c_ap3220, 1);
